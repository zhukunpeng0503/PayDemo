...
//				if (LibDebug.isLogOn) {
//					LogUtils.log(TAG, "toJson(o):", "Exception: " + e);
//				}
			}
			try {
...
//				if (LibDebug.isLogOn) {
//					LogUtils.log(TAG, "toJson(o):map2Json", "Exception: " + e);
//				}
			}
...
//				if (LibDebug.isLogOn) {
//					LogUtils.log(TAG, "toJson(o):ToJson", "Exception: " + e);
//				}
			}
			try {
...
//				if (LibDebug.isLogOn) {
//					LogUtils.log(TAG, "toJson(o):hashset2Json", "Exception: " + e);
//				}
			}
			if (silentfail) {
				return o + "";
...
//		if (LibDebug.isLogOn) {
//			LogUtils.loge(TAG, "TAG Unsupported type: "
//					+ o.getClass().getName());
//		}
...
//						if (LibDebug.isLogOn) {
//							LogUtils.log(TAG, "map2Json(o)", "Exception: " + e);
//						}
					}
				}
			}
...
//						if (LibDebug.isLogOn) {
//							LogUtils.log(TAG, "hashset2Json(o)", "Exception: " + e);
//						}
					}
				}
			}
